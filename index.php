...
<body>
  ...
  <div class="container-fluid position-relative">
    ...
    <section class="hero section-container">
      <div class="text-box">
        <h2 class="text-center fs-1 heading">Buy, Sell, and Swap your Gadgets in one place.</h2>
      ...
      <form class="search-form">
        <div class="search-bar position-relative p-0 m-0 overflow-hidden">
          ...
          <button type="submit" class="position-absolute end-0 top-0 bottom-0 search-btn">
            <span class="icon">
      ...
      <div class="phone-section sub-section">
        ...
        <div class="swiper phone-swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide card gadget">
              <div class="img-box position-relative">
                <img src="" alt="Gadget image" />
    ...
    <footer class="section-container footer-section py-0">
      <div class="footer-inner">
        ...
        <div class="copyright-bar">
          <p class="text-center copyright m-0">&copy; Blackii's Gadgets, 2025.</p>
        </div>
